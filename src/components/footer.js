        ...
        <div className="bg-[#3F5473] py-20 grid grid-cols-1 place-items-center space-y-10 sm:space-y-0 sm:flex sm:justify-around">
          ...
          <div className="flex flex-col jusitfy-center items-center">
            ...
            <div className="mt-7 flex flex-col justify-center items-center">
              <input
                class="px-2 py-3 text-gray-700 placeholder-gray-500 bg-white outline-none focus:placeholder-transparent poppins rounded-sm placeholder:text-xs sm:w-52 lg:w-72"
                type="text"
                name="email"
